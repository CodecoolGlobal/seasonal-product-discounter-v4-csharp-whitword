...
public class TransactionsSimulator
{
    ...
    public void Run(TransactionsSimulatorSettings settings)
    {
        ...
        while (successfulTransactions <= settings.TransactionsCount)
        {
            ...
            //Create transaction
            var transaction = CreateTransaction(successfulTransactions+1, settings.Date, user, product, offer.Price);
    ...
    private static Transaction CreateTransaction(int id, DateTime date, User user, Product product, double price)
    {
        Transaction transaction = new Transaction(id, date, user, product, price);
        return transaction;
    }
